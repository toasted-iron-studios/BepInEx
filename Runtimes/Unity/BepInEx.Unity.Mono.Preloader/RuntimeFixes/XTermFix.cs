...
internal static class XTermFix
{
    ...
    public static void Apply()
    {
        ...
        // Historically this fix had to force an x86 detour platform here: MonoMod 22's PlatformHelper
        // (used by the old DetourHelper.Native) ran Process.Start to detect ARM/x86, which could run
        // Console..cctor on older Unity Monos before TermInfoReader was patched, crashing. MonoMod 25's
        // PlatformDetection classifies the platform without spawning a process, so that workaround is gone.
